module.exports = [
  {
    ...
    desc: "My Portfolio Website. A tempting UX/UI inspired by the top Portfolios. You are already there !",
    image: "/images/projects/portfolio.png",
    links: {
      view: "#",
      code: "https://github.com/nikhilseth30",
    },
  },
  {
    id: 2,
    name: "Hike-clone",
    desc: "A Project based on React-native tech stack express of React with . One of the top full stack App project ever Made !!",
  ...
  },
  {
    ...
    desc: "An app based on React-native, Routes as well as Star button where we can save our favour dish. It is still under development but do check it out.",
  ...
  },
  {
    id: 5,
    name: "Weather web",
    desc: "Weather web is a basic website where we enter a city,state name from anywhere we get a current weather status",
    image:
  ...
  {
    id: 6,
    name: "Online Notes Generator(todo-list)",
    desc: "Basic-web of showcase a list which we made for us  !!",
  ...
  },
  {
    id: 7,
    name: "Color-changer",
    desc: "Basic web on click change of background - color",
  ...
  },
  {
    id: 8,
    name: "Coffee web",
    desc: "Here is a Coffee page where is can buy and sale a coffee beans  ",
  ...
  {
    id: 11,
    name: "Employee Fetch & Store (Mongoose)",
  ...
  },
  {
    id: 12,
    name: "Sneaker Shop",
    desc: "A Sneaker app where we can purchase a shoes through App ",
  ...
  },
  {
    id: 13,
    name: "CRUD",
    desc: "Node.js app it is a basic web where we can create update nd delete a functionality",
  ...
  },
  {
    ...
    desc: "Employee Salary Account where we manage a Employee Token id then we distribute Salary!!",
  ...
  },
  {
    id: 15,
    name: "Rabbit NEWS",
    desc: "This is React-website, Rabbit NEWS website where we see and get Update ourself from the website ",
  ...
  },
  {
    id: 16,
    name: "Rabbit-Movies",
    desc: "This is a React Movie basic website where we can easily watch a new movie in this website we fetch API too ",
